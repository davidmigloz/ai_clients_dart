...
_Response _$ResponseFromJson(Map<String, dynamic> json) => _Response(
  id: json['id'] as String,
  object:
      $enumDecodeNullable(_$ObjectTypeEnumMap, json['object']) ??
...
_ResponseConfig _$ResponseConfigFromJson(Map<String, dynamic> json) =>
    _ResponseConfig(
      ...
      outputAudioFormat: $enumDecodeNullable(
        ...
        json['output_audio_format'],
        unknownValue: JsonKey.nullForUndefinedEnumValue,
      ),
      tools: (json['tools'] as List<dynamic>?)
          ?.map((e) => ToolDefinition.fromJson(e as Map<String, dynamic>))
          .toList(),
      toolChoice: const _ResponseConfigToolChoiceConverter().fromJson(
        json['tool_choice'],
      ),
      temperature: (json['temperature'] as num?)?.toDouble(),
      maxResponseOutputTokens:
          const _ResponseConfigMaxResponseOutputTokensConverter().fromJson(
            json['max_response_output_tokens'],
          ),
      conversation: const _ResponseConfigConversationConverter().fromJson(
        json['conversation'],
      ),
      metadata: json['metadata'] as Map<String, dynamic>?,
...
_$ResponseConfigToolChoiceToolChoiceForcedFromJson(Map<String, dynamic> json) =>
    ResponseConfigToolChoiceToolChoiceForced(
...
_$ResponseConfigMaxResponseOutputTokensIntFromJson(Map<String, dynamic> json) =>
    ResponseConfigMaxResponseOutputTokensInt(
...
_Session _$SessionFromJson(Map<String, dynamic> json) => _Session(
  ...
  turnDetection: json['turn_detection'] == null
      ? null
      : TurnDetection.fromJson(json['turn_detection'] as Map<String, dynamic>),
  tools: (json['tools'] as List<dynamic>?)
      ?.map((e) => ToolDefinition.fromJson(e as Map<String, dynamic>))
      .toList(),
  toolChoice: const _SessionToolChoiceConverter().fromJson(json['tool_choice']),
  temperature: (json['temperature'] as num?)?.toDouble(),
...
_SessionConfig _$SessionConfigFromJson(Map<String, dynamic> json) =>
    _SessionConfig(
      ...
      tools: (json['tools'] as List<dynamic>?)
          ?.map((e) => ToolDefinition.fromJson(e as Map<String, dynamic>))
          .toList(),
      toolChoice: const _SessionConfigToolChoiceConverter().fromJson(
        json['tool_choice'],
      ),
      temperature: (json['temperature'] as num?)?.toDouble(),
      maxResponseOutputTokens:
          const _SessionConfigMaxResponseOutputTokensConverter().fromJson(
            json['max_response_output_tokens'],
          ),
    );
...
_$SessionConfigToolChoiceToolChoiceForcedFromJson(Map<String, dynamic> json) =>
    SessionConfigToolChoiceToolChoiceForced(
      ToolChoiceForced.fromJson(json['value'] as Map<String, dynamic>),
      $type: json['runtimeType'] as String?,
    );
...
_$SessionConfigMaxResponseOutputTokensIntFromJson(Map<String, dynamic> json) =>
    SessionConfigMaxResponseOutputTokensInt(
      (json['value'] as num).toInt(),
      $type: json['runtimeType'] as String?,
    );
...
ItemMessage _$ItemMessageFromJson(Map<String, dynamic> json) => ItemMessage(
  ...
  type:
      $enumDecodeNullable(_$ItemTypeEnumMap, json['type']) ?? ItemType.message,
...
_$RealtimeEventConversationItemCreateFromJson(Map<String, dynamic> json) =>
    RealtimeEventConversationItemCreate(
      eventId: json['event_id'] as String,
      type:
          $enumDecodeNullable(_$RealtimeEventTypeEnumMap, json['type']) ??
...
_$RealtimeEventConversationItemTruncateFromJson(Map<String, dynamic> json) =>
    RealtimeEventConversationItemTruncate(
      eventId: json['event_id'] as String,
      type:
          $enumDecodeNullable(_$RealtimeEventTypeEnumMap, json['type']) ??
...
_$RealtimeEventConversationItemInputAudioTranscriptionCompletedToJson(
  RealtimeEventConversationItemInputAudioTranscriptionCompleted instance,
) => <String, dynamic>{
  'event_id': instance.eventId,
  'type': _$RealtimeEventTypeEnumMap[instance.type]!,
  'item_id': instance.itemId,
...
Map<String, dynamic>
_$RealtimeEventConversationItemInputAudioTranscriptionFailedToJson(
...
Map<String, dynamic>
_$RealtimeEventConversationItemInputAudioTranscriptionDeltaToJson(
...
_$RealtimeEventConversationItemTruncatedFromJson(Map<String, dynamic> json) =>
    RealtimeEventConversationItemTruncated(
      eventId: json['event_id'] as String,
      type:
          $enumDecodeNullable(_$RealtimeEventTypeEnumMap, json['type']) ??
...
_$RealtimeEventInputAudioBufferCommittedFromJson(Map<String, dynamic> json) =>
    RealtimeEventInputAudioBufferCommitted(
      eventId: json['event_id'] as String,
      type:
          $enumDecodeNullable(_$RealtimeEventTypeEnumMap, json['type']) ??
...
_$RealtimeEventResponseAudioTranscriptDoneFromJson(Map<String, dynamic> json) =>
    RealtimeEventResponseAudioTranscriptDone(
      eventId: json['event_id'] as String,
      type:
          $enumDecodeNullable(_$RealtimeEventTypeEnumMap, json['type']) ??
...
_$RealtimeEventResponseContentPartAddedFromJson(Map<String, dynamic> json) =>
    RealtimeEventResponseContentPartAdded(
      eventId: json['event_id'] as String,
      type:
          $enumDecodeNullable(_$RealtimeEventTypeEnumMap, json['type']) ??
...
RealtimeEventConversationUpdated _$RealtimeEventConversationUpdatedFromJson(
  ...
  result: EventHandlerResult.fromJson(json['result'] as Map<String, dynamic>),
);
...
_$RealtimeEventConversationItemAppendedFromJson(Map<String, dynamic> json) =>
    RealtimeEventConversationItemAppended(
      eventId: json['event_id'] as String,
      type:
          $enumDecodeNullable(_$RealtimeEventTypeEnumMap, json['type']) ??
...
_$RealtimeEventConversationItemCompletedFromJson(Map<String, dynamic> json) =>
    RealtimeEventConversationItemCompleted(
      eventId: json['event_id'] as String,
      type:
          $enumDecodeNullable(_$RealtimeEventTypeEnumMap, json['type']) ??
