...
class ChatStreamAccumulator {
  ...
  Logprobs? _buildLogprobs(_AccumulatedChoice choice) {
    ...
    return Logprobs(
      content:
          choice.logprobsContent.isNotEmpty ? choice.logprobsContent : null,
      refusal:
          choice.logprobsRefusal.isNotEmpty ? choice.logprobsRefusal : null,
    );
  }
  ...
  String get content =>
      _choices.isEmpty ? '' : _choices[0].content.toString();

  /// The accumulated refusal content.
  ///
  /// For multi-choice streams, returns choice 0's refusal.
  String get refusal =>
      _choices.isEmpty ? '' : _choices[0].refusal.toString();
