...
void main() {
  group('WorkflowExecutionTraceEventsResponse', () {
    ...
    test('fromJson parses all fields', () {
      final response = WorkflowExecutionTraceEventsResponse.fromJson(
        responseJson(),
      );
    ...
    test('toJson round-trips', () {
      ...
      expect(
        WorkflowExecutionTraceEventsResponse.fromJson(response.toJson()),
        equals(response),
      );
    });
    ...
    test('equality and hashCode', () {
      final a = WorkflowExecutionTraceEventsResponse.fromJson(responseJson());
      final b = WorkflowExecutionTraceEventsResponse.fromJson(responseJson());
      final c = WorkflowExecutionTraceEventsResponse.fromJson({
        ...responseJson(),
        'user_id': 'different',
      });
    ...
    test('throws FormatException when a required field is missing', () {
      for (final key in [
        ...
        expect(
          () => WorkflowExecutionTraceEventsResponse.fromJson(json),
