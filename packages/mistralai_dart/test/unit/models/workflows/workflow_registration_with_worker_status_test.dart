...
void main() {
  group('WorkflowRegistrationWithWorkerStatus', () {
    ...
    test('fromJson parses all fields', () {
      final registration = WorkflowRegistrationWithWorkerStatus.fromJson(
        registrationJson(),
      );
    ...
    test('toJson round-trips', () {
      ...
      expect(
        WorkflowRegistrationWithWorkerStatus.fromJson(registration.toJson()),
        equals(registration),
      );
    });
    ...
    test('equality and hashCode', () {
      final a = WorkflowRegistrationWithWorkerStatus.fromJson(
        registrationJson(),
      );
      final b = WorkflowRegistrationWithWorkerStatus.fromJson(
        registrationJson(),
      );
      final c = WorkflowRegistrationWithWorkerStatus.fromJson({
        ...registrationJson(),
