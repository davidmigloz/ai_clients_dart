...
All verification scripts are in `.agents/shared/openapi-toolkit/scripts/` and require `--config-dir packages/mistralai_dart/.agents/skills/openapi-mistral/config`:
