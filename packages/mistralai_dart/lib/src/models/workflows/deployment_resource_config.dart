...
/// Resource configuration (CPU/memory/replicas) for a managed deployment.
@immutable
class DeploymentResourceConfig {
  ...
  /// Creates a [DeploymentResourceConfig].
  const DeploymentResourceConfig({
    this.cpuLimit,
    this.cpuRequest,
    this.memoryLimit,
    this.memoryRequest,
  ...
  /// Creates a [DeploymentResourceConfig] from JSON.
  factory DeploymentResourceConfig.fromJson(Map<String, dynamic> json) =>
  ...
  DeploymentResourceConfig copyWith({
    ...
    return DeploymentResourceConfig(
  ...
  bool operator ==(Object other) {
    ...
    if (other is! DeploymentResourceConfig) return false;
