...
/// Request body to update a skill version's metadata.
@immutable
class UpdateSkillVersionRequest {
  ...
  /// Creates an [UpdateSkillVersionRequest].
  ///
  /// Asserts that [clearNotes] is not `true` while [notes] is also non-null.
  const UpdateSkillVersionRequest({
    this.aliases,
    this.notes,
  ...
  UpdateSkillVersionRequest copyWith({
    ...
    return UpdateSkillVersionRequest(
  ...
  bool operator ==(Object other) =>
      ...
      other is UpdateSkillVersionRequest &&
  ...
  @override
  String toString() =>
      'UpdateSkillVersionRequest(aliases: $aliases, notes: $notes, '
