...
/// Request body to create a new version of a skill.
@immutable
class CreateSkillVersionRequest {
  ...
  /// Creates a [CreateSkillVersionRequest].
  const CreateSkillVersionRequest({
  ...
  CreateSkillVersionRequest copyWith({
  ...
  bool operator ==(Object other) =>
      ...
      other is CreateSkillVersionRequest &&
  ...
  @override
  String toString() =>
      'CreateSkillVersionRequest(definition: $definition, aliases: $aliases, '
      'notes: $notes)';
}
